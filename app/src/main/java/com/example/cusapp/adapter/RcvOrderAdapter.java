...
public class RcvOrderAdapter extends RecyclerView.Adapter<RcvOrderAdapter.ViewHolder>{
    ...
    @Override
    public RcvOrderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RcvOrderAdapter.ViewHolder holder, int position) {
